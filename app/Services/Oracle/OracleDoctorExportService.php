...
SQL;
    ...
    private function buildPayload(RegistrationRequest $registrationRequest): array
    {
        ...
        return [
            ...
            'gender' => $gender,
            'nationality_code' => (int) $registrationRequest->nationality,
            'regision' => (int) $registrationRequest->religion,
            'id_no' => (string) $registrationRequest->national_id,
            'birthdate' => $birthDate,
            'born_gov' => (int) $registrationRequest->birth_governorate,
            'degree_code' => (int) $registrationRequest->grade,
            'university_code' => (int) $registrationRequest->university,
