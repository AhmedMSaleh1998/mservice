...
class NewRegisterDTO
{
    public function __construct(
        ...
        public readonly string $residenceMobile1CountryCode,
        public readonly string $residenceMobile1,
        public readonly ?string $residenceMobile2CountryCode,
    ...
    public static function fromRequest($request): self
    {
        return new self(
            ...
            $request->input('residence_mobile_1_country_code'),
            $request->input('residence_mobile_1'),
            $request->filled('residence_mobile_2_country_code') ? $request->input('residence_mobile_2_country_code') : null,
            $request->filled('residence_mobile_2') ? $request->input('residence_mobile_2') : null,
            $request->input('email'),
